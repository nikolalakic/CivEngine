...
V_{d} &= V_{g} + V_{q} \\
H_{Rd} &= \frac{V_{d} \cdot \tan(\phi'_2)}{\gamma_{r,h}} + c_{a, coefficient} \frac{ B \cdot c_{a}}{\gamma_{r,h}} \\
...
H_{Rd} &= \frac{vd_slide \cdot \tan(phi_prime_stab_2)}{gamma_rh} + coefficient_ca \cdot \frac{B_final \cdot cohesion}{gamma_rh} = hrd_slide \text{ } [kN/m] \\
